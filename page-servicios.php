...
<div class="container" id="botonera-servicios">
	<div class="col-md-4">
		<a href="<?php echo site_url(); ?>/todos-los-servicios/envio-de-encomiendas/">
			<img src="<?php echo get_stylesheet_directory_uri();?>/images/01-servicios-b.jpg" alt="">
	...
	<div class="col-md-4">
		<a href="<?php echo site_url(); ?>/todos-los-servicios/envio-de-documento-comerciales-servicio-de-bolsin-tdc/">
			<img src="<?php echo get_stylesheet_directory_uri();?>/images/02-servicios-b.jpg" alt="">
	...
	<div class="col-md-4">
		<a href="<?php echo site_url(); ?>/todos-los-servicios/servicios-para-comercio-electronico/">
			<img src="<?php echo get_stylesheet_directory_uri();?>/images/03-servicios-b.jpg" alt="">
	...
	<div id="main" class="container single-page">
			<section class="content col-md-8 col-md-offset-2 ">
				...
				<ul>
					...
					<li>
						<h3><a href="<?php echo site_url(); ?>/integral-cash-envio-de-dinero/">Integral Cash (Envío de Dinero)</a></h3>
						<p><a href="<?php echo site_url(); ?>/integral-cash-envio-de-dinero/">Servicio RC</a></p>
					</li>
				</ul>
			</section>
	</div>
