				...
				<div class="carousel slide carousel-fade" id="carousel-flota" data-ride="carousel">
					...
					<div class="carousel-inner col-md-12" role="listbox"> 
						<div class="item active">
							<img src="<?php echo get_stylesheet_directory_uri();?>/images/carousel_flota1.jpg" alt="">
						</div> 
						<div class="item"> 
							<img src="<?php echo get_stylesheet_directory_uri();?>/images/carousel_flota2.jpg" alt="">
						</div> 
						<div class="item"> 
							<img src="<?php echo get_stylesheet_directory_uri();?>/images/carousel_flota3.jpg" alt="">
						</div> 
						<div class="item"> 
							<img src="<?php echo get_stylesheet_directory_uri();?>/images/carousel_flota4.jpg" alt="">
						</div> 
					</div> 
				</div>
			</header>
			<div class="second_title">
				Camionetas y utilitarios <strong>propios</strong>
			</div>
			<section class="single-page-content">
			<div class="col-container">
				<div class="lineas-diagonales-page col-md-1 col"></div>	
				<div class="col col-md-12 contenido-page"> <?php the_content(); ?></div>
			</div>
			</section>
		<?php endwhile;?>
	<?php endif; ?>
